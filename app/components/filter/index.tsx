...
const Filter = () => {
    ...
    return (
        <section className="border-b border-orange-400 flex justify-center mb-2">
            <div className="p-2 pt-0 w-full max-w-3xl">
                ...
                <div className="flex justify-end">
                    <button className="text-orange-400 font-bold text-xs" onClick={showOptions}>{`Mostrar ${isShowOptions ? 'menos' : 'mais'} opções`}</button>
                </div>
            </div>
        </section>
    )
