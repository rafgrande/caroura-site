const Highlights = () => (
    <>
        <section className='py-2 relative border-b border-b-orange-400 overflow-hidden lg:max-w-3xl lg:m-auto'>
            <div className="noscroll overflow-scroll snap-x flex text-sm font-bold lg:justify-center gap-2">
                <div className="border-orange-400 border-2 p-1 rounded-full basis-24 h-24 shrink-0 snap-center">
